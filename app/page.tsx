  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start gap-5  bg-[#f7f3ff]">
      ...
      <h1 className="lg:text-6xl text-4xl font-extrabold lg:max-w-[550px] max-w-[400px] text-center mt-24">
        <span className="text-primary_purple">Discover</span> a New Money
        Experience
      </h1>
      ...
      <div className="flex lg:flex-row flex-col max-w-[550px] items-center gap-6 mt-[50px] ">
        <div className="flex items-center gap-4 bg-primary_purple rounded-[30px] shadow-xl text-xl font-semibold hover:shadow-none text-white py-3 px-24 lg:px-12 lg:w-fit w-full">
          <div className="  ">Send Money</div>
          <IoIosArrowDown />
        </div>

        <div className="flex items-center gap-4 bg-primary_purple rounded-[30px] shadow-xl hover:shadow-none text-xl font-semibold text-white   py-3 px-20 lg:px-8 lg:w-fit w-full">
