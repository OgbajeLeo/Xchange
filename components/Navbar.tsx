          ...
          <div className="flex flex-1 items-center justify-end gap-x-6">
            {!session ? (
              <>
                <Link
                  href="/login"
                  className="hidden lg:block lg:text-xl lg:font-semibold lg:text-primary_purple  px-10 py-3 rounded-[30px] border border-primary_purple"
                >
                  Sign in
                </Link>

                <div className="flex lg:mr-0 mr-3">
                  <button
                    type="button"
            ...
            <div className="flex items-center gap-x-6">
              ...
              {session ? (
                <button
                  ...
                  className="ml-auto rounded-md border border-1 border-primary-purple px-3 py-2 text-sm font-semibold text-primary-purple shadow-sm hover:bg-white hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Log out
                </button>
              ) : (
